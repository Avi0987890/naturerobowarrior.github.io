...
function setFlyCamera(app) {
    var cam = app.root.findByName("Camera");
    cam.parent.removeChild(cam);
    cam.script.flyCamera.initialize();
    cam.script.flyCamera.enabled = true;
    freeCamera = true;
    pc.shake.enabled = false;
    startMenu.style.display = "none";
    app.root.findByName("cursor").model.enabled = false;
    //app.root.findByName("ammoIndicator").model.enabled = false;
    //app.root.findByName("minimap quad").model.enabled = false;
}
